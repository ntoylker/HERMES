...
- `generate_offense_rag.py` (applied independently to each decomposed part; see [GENERATE_OFFENSE_RAG_INTERNALS.md](GENERATE_OFFENSE_RAG_INTERNALS.md) section 3)
